...
# Define EfficientNetV2-based model
...
# Train the model
history = efficient_model.fit(custom_generator,
                    epochs=10,  
...
test_loss, test_accuracy = efficient_model.evaluate(test_images, test_labels_one_hot)
